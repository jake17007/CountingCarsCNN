...
x_train, y_train, x_test, y_test = pickle.load(open('feature_set_countCars_AllImages_color_cropped.pickle', 'rb'))
...
plt.hist(numericalTargets, bins=101, normed=True)
plt.title('Distribution of Number of Cars Accross Samples (Cropped)')
plt.xlabel('Number of Cars in Photo')
plt.xlim(0,101)
